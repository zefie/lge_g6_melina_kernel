...
void mdss_dsi_ctrl_shutdown(struct platform_device *pdev)
{
	...
	if ((pinfo->panel_type == LGD_SIC_LG49407_1440_2880_INCELL_VIDEO_PANEL) ||
		(pinfo->panel_type == LGD_SIC_LG49408_1440_2880_INCELL_CMD_PANEL)) {
		/* Shutdown sequence for SW49408 & SW49407
		 * LABIBB off - 5ms - Reset L - VPNL off - VDDIO off
		 */
