	...
	int power_state)
{
	...
	pr_debug("[Display] %pS-->%s: cur_power_state=%d req_power_state=%d\n",
...
static int mdss_dsi_off(struct mdss_panel_data *pdata, int power_state)
{
	...
	pr_debug("[Display] %s+: ctrl=%pK ndx=%d power_state=%d\n",
...
int mdss_dsi_on(struct mdss_panel_data *pdata)
{
	...
	pr_debug("[Display] %s+: ctrl=%pK ndx=%d cur_power_state=%d\n", __func__,
