...
static int ce_aes_setkey(struct crypto_tfm *tfm, const u8 *in_key,
             unsigned int key_len)
{
    struct crypto_aes_ctx *ctx = lgecryptow_crypto_tfm_ctx(tfm);
    int ret;
...
static struct crypto_alg aes_algs[] = { {
    .cra_name        = "__lge-ecb-aes-ce",
    .cra_driver_name    = "__driver-lge-ecb-aes-ce",
    .cra_priority        = 300,
    ...
    .cra_name        = "__lge-cbc-aes-ce",
    .cra_driver_name    = "__driver-lge-cbc-aes-ce",
    .cra_priority        = 300,
    .cra_flags        = CRYPTO_ALG_TYPE_BLKCIPHER,
    .cra_blocksize        = AES_BLOCK_SIZE,
    .cra_ctxsize        = sizeof(struct crypto_aes_ctx),
    ...
    .cra_name        = "__lge-ctr-aes-ce",
    .cra_driver_name    = "__driver-lge-ctr-aes-ce",
    .cra_priority        = 300,
    .cra_flags        = CRYPTO_ALG_TYPE_BLKCIPHER,
    .cra_blocksize        = 1,
    .cra_ctxsize        = sizeof(struct crypto_aes_ctx),
    ...
    .cra_name        = "__lge-xts-aes-ce",
    .cra_driver_name    = "__driver-lge-xts-aes-ce",
    .cra_priority        = 300,
    .cra_flags        = CRYPTO_ALG_TYPE_BLKCIPHER,
    .cra_blocksize        = AES_BLOCK_SIZE,
    ...
    .cra_driver_name    = "lge-ecb-aes-ce",
    .cra_priority        = 300,
    ...
    .cra_driver_name    = "lge-cbc-aes-ce",
    .cra_priority        = 300,
    .cra_flags        = CRYPTO_ALG_TYPE_ABLKCIPHER|CRYPTO_ALG_ASYNC,
    .cra_blocksize        = AES_BLOCK_SIZE,
    .cra_ctxsize        = sizeof(struct async_helper_ctx),
    ...
    .cra_driver_name    = "lge-ctr-aes-ce",
    .cra_priority        = 300,
    .cra_flags        = CRYPTO_ALG_TYPE_ABLKCIPHER|CRYPTO_ALG_ASYNC,
    .cra_blocksize        = 1,
    .cra_ctxsize        = sizeof(struct async_helper_ctx),
    ...
    .cra_driver_name    = "lge-xts-aes-ce",
    .cra_priority        = 300,
    .cra_flags        = CRYPTO_ALG_TYPE_ABLKCIPHER|CRYPTO_ALG_ASYNC,
    .cra_blocksize        = AES_BLOCK_SIZE,
    .cra_ctxsize        = sizeof(struct async_helper_ctx),
...
int __init aes_armv8_ce_32_init(void)
{
...
void __exit aes_armv8_ce_32_exit(void)
{
